...
import { AskQuestionView } from "@/components/study/ask-question-view";
...
type AppStep = "introduction" | "input" | "loading" | "dashboard" | "flashcards" | "quiz" | "askQuestion" | "results" | "notes";
      ...
      case "dashboard":
        return (
          <StudyDashboardView
            ...
            onStartAskQuestion={() => setCurrentStep("askQuestion")} 
